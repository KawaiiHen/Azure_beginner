...
During the development of this project, I encountered several challenges and learned key concepts:

- **Data Ingestion Complexity**: Managing data extraction from an on-premises SQL Server required configuring integration runtime in Azure Data Factory.
- **Optimizing Data Processing**: Processing large datasets efficiently in Databricks required performance tuning with optimized Spark configurations.
- **Security Considerations**: Implementing Azure Key Vault and RBAC to securely manage credentials and data access.
- **Visualization and Reporting**: Creating insightful Power BI reports and ensuring they meet business needs.

## Future Enhancements

To further improve the project, I plan to:

- **Implement Real-Time Data Streaming**: Using Azure Event Hub or Kafka for near real-time analytics.
- **Optimize Costs**: Evaluate cost-saving measures in Azure services.
- **Expand Data Sources**: Integrate additional datasets for richer insights.
